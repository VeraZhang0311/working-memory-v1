...
/*
2022-11-28: Van Liceralde copied van Hedger (2020)'s reading span code and turned it into listening span
			...
			Modified instructions to have clearer wording and appropriate for listening span
			Added additional code based on James et al. MATLAB code and reference of WM tasks (Unsworth et al., 2005; 2009)
			- Added a function computing standard deviation because response deadline for participants is meant to be mean + 2.5 SD but only mean in original lspan.js
...
automated listening span task, which is one of
several 'complex span' assessments of working
memory. Participants listen to sentences and determine
whether or not they make sense. This sentence
task is interleaved with a letter memory task,
in which a single letter is played through speakers. Participants go through this interleaved
sentence/letter process anywhere from 2-7 times
on a trial.
...
3. Push the variable 'lspan_final' to your timeline in your html file
References:
...
var lspan_final = {
	timeline: [enter_fullscreen, preload, get_participant_id,
		...
		final_combined_runs, lspan_done, lspan_summary, conclusion]
};