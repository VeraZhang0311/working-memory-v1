...
/*
2022-11-14: Modified by Van Liceralde to be compatible with jsPsych v7.3; see the following migration guide for changes that had to be made
			https://www.jspsych.org/7.0/support/migration-v7/
			Modified instructions to have clearer wording
...
var rspan_instruct_1 = {
	...
	stimulus: "<p style='font-size:25px'><b>Reading and Memory Task</b></p><p style='font-size:25px'>In this task, you will try to memorize letters you see on the screen while you also read sentences.</p>" +
...
var rspan_instruct_4 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>Now you will practice doing the sentence reading part of the task.</p>" +
...
var rspan_instruct_6 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>It is VERY important that you correctly answer whether the sentences make sense.</br>It is also important that you try and read the sentences as quickly as you can.</p>" +
...
var rspan_instruct_8 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>After the letter goes away, another sentence will appear, and then another letter.</p>" +
...
var rspan_instruct_9 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>On the feedback screen, you will also see a number in the top right corner.</br>This indicates your percent correct for answering whether the sentences make sense for the entire task.</p>" +
...
{stimulus: "After one date I knew that Linda's sister simply was not my type.", nonsense: 0},
...
var sentence_judgment_practice = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size: 30px; font-family: Arial;'> This sentence makes sense.</p>",
	choices: ["TRUE", "FALSE"],
	button_html: '<button class="buttonStyle">%choice%</button>',
	on_finish: function(data) {
...
var welcome = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px;'><b>Reading and Memory Task</b></p>" +
...
var lettersentence_practice_final = {
	timeline: [lettersentence_instructions, letterpractice_run, letterpractice_run, rspan_instruct_10]
	};
...
var rspan_summary = {
    ...
    stimulus: function(){return "<p style='font-size:25px;'>There are two scores typically associated with this task.<br>" +
									...
									"<p style='font-size:25px;'></br></br>Your <b>TOTAL</b> score was " + RSPAN_TOTAL + ".</p><p style='font-size:25px;'>Your <b>ABSOLUTE</b> score was " + RSPAN_ABS +".</p>" +
...
//main rspan task
var rspan_final = {
	timeline: [get_participant_id, // get_location,
		welcome, enter_fullscreen,
		letter_practice_final, sentence_practice_final, lettersentence_practice_final,
		final_combined_runs, final_combined_runs, 
		rspan_done, rspan_summary]
};
...
var conclusion = {
	...
	on_start: function(data) {
		if (online == 0) {
			var filename = "data_rspan_" + subject + ".csv";
