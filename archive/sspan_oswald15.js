...
/*
2023-01-20: Created by Van Liceralde

/*
Overview:
This is a jsPsych implementation of the popular
automated symmetry span task, which is one of
several 'complex span' assessments of working
memory. Participants look at pictures and determine
whether are symmetric or not. This picture
task is interleaved with a square memory task,
in which a single square is presented on the
screen. Participants go through this interleaved
picture/square process anywhere from 3-7 times
on a trial.
Then, participants must recall the location of the squares
IN ORDER to the best of their ability. Participants
are also encouraged to keep their picture accuracy
above 85%, keeping in line with prior research.
To Use:
1. Load this js file in your html file.
2. Reference the css (sspanstyle.css) in your html file
3. Push the variable 'sspan_final' to your timeline in your html file
References:
...
var filename_pictures = [
	'SymBitmaps/example_symm1.bmp', 'SymBitmaps/example_symm2.bmp', 'SymBitmaps/example_symm3.bmp', 'SymBitmaps/example_symm4.bmp', 
	'SymBitmaps/pracsymm1.bmp', 'SymBitmaps/pracsymm2.bmp', 'SymBitmaps/pracsymm3.bmp', 'SymBitmaps/pracsymm4.bmp', 
	'SymBitmaps/pracsymm5.bmp', 'SymBitmaps/pracsymm6.bmp', 'SymBitmaps/pracsymm7.bmp', 'SymBitmaps/pracsymm8.bmp', 
	'SymBitmaps/pracsymm9.bmp', 'SymBitmaps/pracsymm10.bmp', 'SymBitmaps/pracsymm11.bmp', 'SymBitmaps/pracsymm12.bmp', 
	'SymBitmaps/pracsymm13.bmp', 'SymBitmaps/pracsymm14.bmp', 'SymBitmaps/pracsymm15.bmp', 'SymBitmaps/symm1.bmp', 
	'SymBitmaps/symm2.bmp', 'SymBitmaps/symm3.bmp', 'SymBitmaps/symm4.bmp', 'SymBitmaps/symm5.bmp', 'SymBitmaps/symm6.bmp', 
	'SymBitmaps/symm7.bmp', 'SymBitmaps/symm8.bmp', 'SymBitmaps/symm9.bmp', 'SymBitmaps/symm10.bmp', 'SymBitmaps/symm11.bmp', 
	'SymBitmaps/symm12.bmp', 'SymBitmaps/symm13.bmp', 'SymBitmaps/symm14.bmp', 'SymBitmaps/symm15.bmp', 'SymBitmaps/symm16.bmp', 
	'SymBitmaps/symm17.bmp', 'SymBitmaps/symm18.bmp', 'SymBitmaps/symm19.bmp', 'SymBitmaps/symm20.bmp', 'SymBitmaps/symm21.bmp', 
	'SymBitmaps/symm22.bmp', 'SymBitmaps/symm23.bmp', 'SymBitmaps/symm24.bmp', 'SymBitmaps/symm25.bmp', 'SymBitmaps/symm26.bmp', 
	'SymBitmaps/symm27.bmp', 'SymBitmaps/symm28.bmp', 'SymBitmaps/symm29.bmp', 'SymBitmaps/symm30.bmp', 'SymBitmaps/symm31.bmp', 
	'SymBitmaps/symm32.bmp', 'SymBitmaps/symm33.bmp', 'SymBitmaps/symm34.bmp', 'SymBitmaps/symm35.bmp', 'SymBitmaps/symm36.bmp', 
	'SymBitmaps/symm37.bmp', 'SymBitmaps/symm38.bmp', 'SymBitmaps/symm39.bmp', 'SymBitmaps/symm40.bmp', 'SymBitmaps/symm41.bmp', 
	'SymBitmaps/symm42.bmp', 'SymBitmaps/symm43.bmp', 'SymBitmaps/symm44.bmp', 'SymBitmaps/symm45.bmp', 'SymBitmaps/symm46.bmp', 
	'SymBitmaps/symm47.bmp', 'SymBitmaps/symm48.bmp'
]
...
// new to v7.2: Set seed so that sampling is the same across runs of the experiment
// CONFIRMED OMGGGG
...
var sspan_instruct_1 = {
	...
	stimulus: "<p style='font-size:25px'><b>Picture and Memory Task</b></p><p style='font-size:25px'>In this task, you will try to memorize the position of colored squares you see on the screen while you also make judgments about other pictures.</p>" +
	...
	on_finish: function(){practice = true; showPattACC = false;} //switching practice to true for dynamic data, switching picture feedback to false
};

var sspan_instruct_2 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>For this practice set, squares will appear on the screen one at a time. Try to remember where each square was, in the order it was presented.</p>" +
...
var sspan_instruct_3 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>Remember, it is very important to get the squares in the same order as you see them.</p>" +
...
var sspan_instruct_4 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>Now you will practice doing the symmetry part of the task.</p>" +
...
var sspan_instruct_5 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<img src='SymBitmaps/example_symm2.bmp' width = '500px', height = '350px'><br>" +
...
var sspan_instruct_6 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<img src='SymBitmaps/example_symm3.bmp' width = '500px', height = '350px'><br>" +
...
var sspan_instruct_7 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<img src='SymBitmaps/example_symm4.bmp' width = '500px', height = '350px'><br>" +
...
var sspan_instruct_8 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>Once you have decided if the picture is symmetrical, click the mouse.</p>" +
...
var sspan_instruct_9 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>It is VERY important that you correctly determine whether the pictures are symmetrical.</br>It is also important that you try and judge the pictures as quickly as you can.</p>" +
...
var sspan_instruct_10 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>Now you will practice doing both parts of the task at the same time.</p>" +
...
var sspan_instruct_11 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>After the square goes away, another picture will appear, and then another square.</p>" +
...
var sspan_instruct_12 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px'>On the feedback screen, you will also see a number in the top right corner.</br>This indicates your percent correct for the symmetry problems for the entire task.</p>" +
	...
	post_trial_gap: 250,
	button_html: '<button class="buttonStyle">%choice%</button>',
	on_finish: function(){showPattACC = true;} //switching to show picture accuracy for square+picture practice
};
...
var practice_pictures = [
	{ stimulus: 'SymBitmaps/pracsymm14.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/pracsymm8.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/pracsymm9.bmp', asymmetric: 1}, 
	{ stimulus: 'SymBitmaps/pracsymm5.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/pracsymm10.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/pracsymm15.bmp', asymmetric: 1},
	{ stimulus: 'SymBitmaps/pracsymm3.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/pracsymm1.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/pracsymm12.bmp', asymmetric: 1}, 
	{ stimulus: 'SymBitmaps/pracsymm7.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/pracsymm6.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/pracsymm4.bmp', asymmetric: 0}, 
	{ stimulus: 'SymBitmaps/pracsymm13.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/pracsymm11.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/pracsymm2.bmp', asymmetric: 0}	
];

var main_pictures = [
	{ stimulus: 'SymBitmaps/symm1.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm2.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm3.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm4.bmp', asymmetric: 0}, 
	{ stimulus: 'SymBitmaps/symm5.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm6.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm7.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm8.bmp', asymmetric: 0}, 
	{ stimulus: 'SymBitmaps/symm9.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm10.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm11.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm12.bmp', asymmetric: 0}, 
	{ stimulus: 'SymBitmaps/symm13.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm14.bmp', asymmetric: 0}, // { stimulus: 'SymBitmaps/symm15.bmp', asymmetric: 0}, { stimulus: 'SymBitmaps/symm16.bmp', asymmetric: 0}, 
	...
	{ stimulus: 'SymBitmaps/symm25.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm26.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm27.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm28.bmp', asymmetric: 1}, 
	{ stimulus: 'SymBitmaps/symm29.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm30.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm31.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm32.bmp', asymmetric: 1}, 
	{ stimulus: 'SymBitmaps/symm33.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm34.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm35.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm36.bmp', asymmetric: 1}, 
	{ stimulus: 'SymBitmaps/symm37.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm38.bmp', asymmetric: 1} //, { stimulus: 'SymBitmaps/symm39.bmp', asymmetric: 1}, { stimulus: 'SymBitmaps/symm40.bmp', asymmetric: 1}, 
	...
	for (var i = 1 ; i <= 16; i++) {
		if (i == pos) {
			...
			switch (i) {
				...
				case 12:
				case 16:
					grid = grid + '<button id = button_' + i + ' class = "num-button" style = "background-color: red; color: red">*</button><br>';
					break;
				default:
					grid = grid + '<button id = button_' + i + ' class = "num-button" style = "background-color: red; color: red">*</button>';
					break;
			}
		}
		...
		if (i != pos) {
			switch (i) {
				...
				case 12:
				case 16:
					grid = grid + '<button id = button_' + i + ' class = "num-button">*</button><br>';
					break;
				default:
					grid = grid + '<button id = button_' + i + ' class = "num-button">*</button>';
					break;
			}
		}
	}
...
var picture_presentation_practice = {
	...
	stimulus: '',
	post_trial_gap: 250,
	choices: [function(){ return '<img src="' + practice_pictures[calibRTindex].stimulus + '" style = "width: 1200px; height: 840px;">';}],
...
var picture_judgment_practice = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size: 30px; font-family: Arial;'> Is this symmetrical? </p>",
	choices: ["TRUE", "FALSE"],
	button_html: '<button class="buttonStyle">%choice%</button>',
	on_finish: function(data) {
...
var overall_practice_feedback = {
	...
	stimulus: function(){
		if(picPracticeCorrect > 12) {
			return '<p style="font-size: 25px;">You responded correctly on ' + picPracticeCorrect + ' of ' + calibRTindex + ' pictures. Good job!</p>';
		} else {
			return '<p style="font-size: 25px;">You only responded correctly on ' + picPracticeCorrect + ' of ' + calibRTindex + ' pictures.</p><p style="font-size: 20px;"><b>In the main task, you must try harder to answer accurately.</b></p>';}
		},
	choices: ['CONTINUE'],
	button_html: '<button class="buttonStyle">%choice%</button>'
};
...
var picture_presentation_main = {
	...
	stimulus: '',
	post_trial_gap: 250,
	choices: [function(){ return '<img src="' + main_pictures[mainSelectionIndex].stimulus + '" style = "width: 1200px; height: 840px;">';}],
	button_html: '<button class="fullscreenStyle">%choice%</button>',
...
var recordClick = function(elm, squarepos) {
...
'<button id = button_1 class = "num-button" onclick = "recordClick(this, 1)">*</button>' +
'<button id = button_2 class = " num-button" onclick = "recordClick(this, 2)">*</button>' +
'<button id = button_3 class = " num-button" onclick = "recordClick(this, 3)">*</button>' +
'<button id = button_4 class = " num-button" onclick = "recordClick(this, 4)">*</button><br>' +
'<button id = button_5 class = " num-button" onclick = "recordClick(this, 5)">*</button>' +
'<button id = button_6 class = " num-button" onclick = "recordClick(this, 6)">*</button>' +
'<button id = button_7 class = " num-button" onclick = "recordClick(this, 7)">*</button>' +
'<button id = button_8 class = " num-button" onclick = "recordClick(this, 8)">*</button><br>' +
'<button id = button_9 class = " num-button" onclick = "recordClick(this, 9)">*</button>' +
'<button id = button_10 class = " num-button" onclick = "recordClick(this, 10)">*</button>' +
'<button id = button_11 class = " num-button" onclick = "recordClick(this, 11)">*</button>' +
'<button id = button_12 class = " num-button" onclick = "recordClick(this, 12)">*</button><br>' +
'<button id = button_13 class = " num-button" onclick = "recordClick(this, 13)">*</button>' +
'<button id = button_14 class = " num-button" onclick = "recordClick(this, 14)">*</button>' +
'<button id = button_15 class = " num-button" onclick = "recordClick(this, 15)">*</button>' +
'<button id = button_16 class = " num-button" onclick = "recordClick(this, 16)">*</button><br>' +
'<br><br><br>' +
	...
	on_finish: function(data){
		...
		for (i = 0; i < correctSEQ.length; i++) {
			if (correctSEQ[i] == response[i]) {
				if(practice == false){SSPAN_TOTAL +=1;} //add to sspan total if not practice
				trialCorrect[i] = 1;
				} else {
				trialCorrect[i] = 0;
			}
		...
		if (!(correctSEQ.includes(i))) {
			...
			if (correctSEQ[csi] == response[csi]) {
				switch (i) {
					...
					case 12:
					case 16:
						grid = grid + '<button id = button_' + i + ' class = "num-button" style = "background-color: red;">' + (correctSEQ.indexOf(i) + 1) + '</button><br>';
						break;
					default:
						grid = grid + '<button id = button_' + i + ' class = "num-button" style = "background-color: red;">' + (correctSEQ.indexOf(i) + 1) + '</button>';
						break;
				}
			}
				...
				switch (i) {
					...
					case 12:
					case 16:
						grid = grid + '<button id = button_' + i + ' class = "num-button" style = "background-color: black;">' + (correctSEQ.indexOf(i) + 1) + '</button><br>';
						break;
					default:
						grid = grid + '<button id = button_' + i + ' class = "num-button" style = "background-color: black;">' + (correctSEQ.indexOf(i) + 1) + '</button>';
						break;
				}
			}
	...
	stimulus: function(){
		...
		if(showPattACC==true){
			...
			if(currentACC > 84){var sentFont = "green"}else{var sentFont = "red"} //assign colored font based on 85% accuracy threshold
				...
				var pictureTicker = '<p class = "senFB" id="senFB">Symmetry:</br>'+ currentACC.fontcolor(sentFont) +'</p>';
			} else {
				var pictureTicker = '';
			}
		var getFeedback = jsPsych.data.get().last(1).values()[0].feedback;
		// var feedbackText = getFeedback.join(" ");
		var pageText = '<p>' + drawCorrectGrid() + '</p>' + pictureTicker +
					   '<p style="font-size:28px"> You correctly identified ' + jsPsych.data.get().last(1).values()[0].numCorrect + ' of  '+jsPsych.data.get().last(1).values()[0].LENGTH+' squares.</p>';
...
var welcome = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px;'><b>Picture and Memory Task</b></p>" +
...
var practice_twosquare_trial = {
	timeline: [set_up_2, square_presentation, square_presentation, sspan_recall, feedback_screen]
	};


var practice_threesquare_trial = {
	timeline: [set_up_3, square_presentation, square_presentation, square_presentation, sspan_recall, feedback_screen]
	};

//final square practice proc
var square_practice_final = {
	timeline: [square_instructions, practice_twosquare_trial, practice_twosquare_trial]
};
...
var picture_instructions = {
	timeline: [sspan_instruct_4, sspan_instruct_5, sspan_instruct_6, sspan_instruct_7, sspan_instruct_8, sspan_instruct_9]
};

var picture_practice = {
	timeline: [
	picture_presentation_practice, picture_judgment_practice, picture_judgment_feedback,
	picture_presentation_practice, picture_judgment_practice, picture_judgment_feedback,
	picture_presentation_practice, picture_judgment_practice, picture_judgment_feedback,
	picture_presentation_practice, picture_judgment_practice, picture_judgment_feedback,
	picture_presentation_practice, picture_judgment_practice, picture_judgment_feedback,
...
var picture_practice_final = {
	timeline: [picture_instructions, picture_practice, overall_practice_feedback]
};
...
var squarepicture_practice = {
	timeline: [
	picture_presentation_main, if_timeout_practice, square_presentation,
	picture_presentation_main, if_timeout_practice, square_presentation
	]
};
...
var squarepractice_run = {
	timeline: [set_up_2, squarepicture_practice, squarepicture_practice_feedback],
};

//final combined practice proc
var squarepicture_practice_final = {
	timeline: [squarepicture_instructions, squarepractice_run, squarepractice_run, sspan_instruct_13]
	};
...
var sspan_3_core = {
	timeline: [
    picture_presentation_main, if_timeout_node, square_presentation,
    picture_presentation_main, if_timeout_node, square_presentation,
    picture_presentation_main, if_timeout_node, square_presentation
]
}
...
var sspan_done = {
	type: jsPsychHtmlButtonResponse,
	stimulus: "<p style='font-size:25px;'>Thank you for your responses.</br></br>Click on CONTINUE to see your scores.</p>",
	choices: ['CONTINUE'],
	button_html: '<button class="buttonStyle">%choice%</button>',
	on_finish: function(data){
...
var sspan_summary = {
    type: jsPsychHtmlButtonResponse,
    stimulus: function(){return "<p style='font-size:25px;'>There are two scores typically associated with this task.<br>" +
									...
									"<p style='font-size:25px;'></br></br>Your <b>TOTAL</b> score was " + SSPAN_TOTAL + ".</p><p style='font-size:25px;'>Your <b>ABSOLUTE</b> score was " + SSPAN_ABS +".</p>" +
...
var sspan_final = {
	timeline: [
		preload, get_participant_id, // get_location, 
		welcome, enter_fullscreen, square_practice_final,
		picture_practice_final, squarepicture_practice_final, final_combined_runs, final_combined_runs, sspan_done, sspan_summary
	]
};
...
//  function saveData() {
// 	 if(localSave == 1) {
// 		 var identifier = 'SSPAN_'+Math.round(new Date().getTime()/1000)+'.csv';
...
//  var save_data = {
// 	 type: jsPsychHtmlButtonResponse,
// 	 stimulus: '<p>Would you like to save the data locally?</p>',
// 	 choices: ['No','Yes'],
// 	 on_finish: function(data){
// 		 localSave = data.response;
// 	 }
//  };
...
var conclusion = {
	...
	on_start: function(data) {
		if (online == 0) {
			var filename = "data_sspan_" + subject + ".csv";
...
var exit_fullscreen = {
 ...
 // Invoke the method/function that deploys the jsPsych code to initialize the experiment
 // v6.3
 // jsPsych.init({
 //     timeline: timeline // takes an array that indicates the order of trials in the experiment
 // })

 // New to v7: replaces jsPsych.init
